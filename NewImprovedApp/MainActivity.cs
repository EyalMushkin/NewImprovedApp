...
namespace NewImprovedApp
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        private string usernameX = OnOpenActivity.username5;
        ...
        protected override void OnNewIntent(Intent intent)
        {
            ...
            alertMessage.SetMessage("Hi-Five received"); // Here's the id of card
            alertMessage.Show();
            ...
            alertMessage.SetMessage("NFC ACTIVATED"); // Here's the id of card
            alertMessage.Show();
        }
